...
/**
 * Get Connections to the SQL DataBase by singleton pool of connections 
 */
public class ConnectionPoolSingleton {
	...
	public synchronized Connection getConnection() throws MyException {
		...
		// waiting if the connection pool is empty
			...
			throw new MyException("PoolSingleton: An Error occured while trying to GET a connection: " + e.getMessage());
		}
	}
	...
	private Connection createConnection() throws MyException {
		try	{
			Class.forName("com.mysql.jdbc.Driver");
			Connection connection;
			connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/CouponsProject?user=root&password=1234&useSSL=false");
			return connection;
		}
		catch (Exception e){
			throw new MyException("PoolSingleton: An Error occured while trying to CREATE a connection: " + e.getMessage());
		}
	}
